...
resource "azurerm_network_interface" "rulesengine-nic1" {
  ...
  ip_configuration {
    ...
    subnet_id                     = "/subscriptions/${var.subscription_id}/resourceGroups/${var.resource_group}/providers/Microsoft.Network/virtualNetworks/core-infra-vnet-snl/subnets/core-infra-subnet-2-snl"
