...
import uk.gov.hmcts.reform.sandl.snlrules.performance.utils.JwtTokenHelper
...
class PipelineSimulation extends Simulation {
  ...
  val headers_json = Map("Content-Type" -> "application/json") ++ JwtTokenHelper.createRulesAuthenticationHeader()
