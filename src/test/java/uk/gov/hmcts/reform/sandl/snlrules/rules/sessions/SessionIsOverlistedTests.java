...
public class SessionIsOverlistedTests {
    ...
    public void should_be_problem_when_session_is_overlisted_50pct_1to3_days_before_start() {
        ...
        rules.insert(new HearingPart("15e461e7-a846-41e5-bb99-fd6c780e82d3", sessionId_3, "FTRACK", Duration.ofMinutes(50)));
    ...
    public void should_be_problem_when_session_is_overlisted_100pct_3to7_days_before_start() {
        ...
        rules.insert(new Session(sessionId_4, judgeId, roomId,
            OffsetDateTime.of(2018, 5, 31, 9, 0, 0, 0, ZoneOffset.UTC),
            Duration.ofMinutes(60), "FTRACK"));

        rules.insert(new HearingPart("af010ad0-0284-4d83-8d94-cf6637ad04ea", sessionId_1, "FTRACK", Duration.ofMinutes(120)));
